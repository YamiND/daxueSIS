  ...
  <body class="nav-md">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" id="delete-assignment-form" class="form-horizontal form-label-left">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Class to delete Assignment from</label>
                    ...
                    <form method="post" id="delete-assignment-form-2" class="form-horizontal form-label-left">
    ...
    <script>
      $(document).ready(function() {  
        ...
        $("#delete-assignment-form-2").hide();

        // submit form using $.ajax() method
        $('#delete-assignment-form').submit(function(e){
        ...
        // submit form using $.ajax() method
        $('#delete-assignment-form-2').submit(function(e){
          e.preventDefault(); // Prevent Default Submission
          
          $.ajax({
            url: '/includes/assignments/deleteAssignment.php',
            type: 'POST',
            data: $(this).serialize() // it will serialize the form data
          })
          .done(function(data){
              ...
              $("#delete-assignment-form-2").hide();
              $("#delete-assignment-form-2")[0].reset();
              // On load have our classes populate
              loadTeacherClasses();

              $('#classID').val([]).trigger('change');
              $("#delete-assignment-form").show();
          })
          .fail(function(){
            alert('Ajax Submit Failed ...');  
          });
